...
const config_item_t CONFIG_ITEMS[] = {
    ...
    // NTRIP
    {.key = KEY_CONFIG_NTRIP_SERVER1_ACTIVE,
     .type = CONFIG_ITEM_TYPE_BOOL,
     .def.bool1 = false},
    {.key = KEY_CONFIG_NTRIP_SERVER1_COLOR,
     .type = CONFIG_ITEM_TYPE_COLOR,
     .def.color.rgba = 0x00000055u},
    {.key = KEY_CONFIG_NTRIP_SERVER1_HOST,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER1_PORT,
     .type = CONFIG_ITEM_TYPE_UINT16,
     .def.uint16 = 2101},
    {.key = KEY_CONFIG_NTRIP_SERVER1_MOUNTPOINT,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER1_USERNAME,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER1_PASSWORD,
     .type = CONFIG_ITEM_TYPE_STRING,
     .secret = true,
     .def.str = ""},

    {.key = KEY_CONFIG_NTRIP_SERVER2_ACTIVE,
     .type = CONFIG_ITEM_TYPE_BOOL,
     .def.bool1 = false},
    {.key = KEY_CONFIG_NTRIP_SERVER2_COLOR,
     .type = CONFIG_ITEM_TYPE_COLOR,
     .def.color.rgba = 0x00000055u},
    {.key = KEY_CONFIG_NTRIP_SERVER2_HOST,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER2_PORT,
     .type = CONFIG_ITEM_TYPE_UINT16,
     .def.uint16 = 2101},
    {.key = KEY_CONFIG_NTRIP_SERVER2_MOUNTPOINT,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER2_USERNAME,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER2_PASSWORD,
     .type = CONFIG_ITEM_TYPE_STRING,
     .secret = true,
     .def.str = ""},

    {.key = KEY_CONFIG_NTRIP_SERVER3_ACTIVE,
     .type = CONFIG_ITEM_TYPE_BOOL,
     .def.bool1 = false},
    {.key = KEY_CONFIG_NTRIP_SERVER3_COLOR,
     .type = CONFIG_ITEM_TYPE_COLOR,
     .def.color.rgba = 0x00000055u},
    {.key = KEY_CONFIG_NTRIP_SERVER3_HOST,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER3_PORT,
     .type = CONFIG_ITEM_TYPE_UINT16,
     .def.uint16 = 2101},
    {.key = KEY_CONFIG_NTRIP_SERVER3_MOUNTPOINT,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER3_USERNAME,
     .type = CONFIG_ITEM_TYPE_STRING,
     .def.str = ""},
    {.key = KEY_CONFIG_NTRIP_SERVER3_PASSWORD,
     .type = CONFIG_ITEM_TYPE_STRING,
     .secret = true,
     .def.str = ""},
...
const config_item_t *config_get_item(const char *key) {
  for (unsigned int i = 0; i < sizeof(CONFIG_ITEMS) / sizeof(config_item_t);
       i++) {
...
esp_err_t config_get_str_blob(const config_item_t *item, void *out_value,
  ...
  case CONFIG_ITEM_TYPE_BLOB:
    ...
    if (ret == ESP_ERR_NVS_NOT_FOUND) {
      if (length != NULL)
        *length = item->def.blob.length;
      if (out_value != NULL)
        memcpy(out_value, item->def.blob.data, item->def.blob.length);
    }
    break;
  default:
    return ESP_ERR_INVALID_ARG;
...
void config_restart() {
  ...
  xTaskCreate(config_restart_task, "config_restart_task", 4096, NULL,
              TASK_PRIORITY_MAX, NULL);
}
